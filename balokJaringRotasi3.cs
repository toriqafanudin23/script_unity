...
public class balokJaringRotasi3 : MonoBehaviour
{
    ...
    public void tutupJaring()
    {
        ...
        objek1.transform.Rotate(Vector3.down, 10f);

        // Rotasi objek2 sekitar sumbu Y sebesar 90 derajat
        objek2.transform.Rotate(Vector3.left, 10f);

        // Rotasi objek3 sekitar sumbu -Y sebesar 90 derajat
        objek3.transform.Rotate(Vector3.right, 10f);
	...
	public void bukaJaring()
    {
		audioBerubah.PlayOneShot(clipBerubah);
        // Rotasi objek1 sekitar sumbu X sebesar 90 derajat
        objek1.transform.Rotate(Vector3.up, 10f);

        // Rotasi objek2 sekitar sumbu Y sebesar 90 derajat
        objek2.transform.Rotate(Vector3.right, 10f);

        // Rotasi objek3 sekitar sumbu -Y sebesar 90 derajat
        objek3.transform.Rotate(Vector3.left, 10f);
